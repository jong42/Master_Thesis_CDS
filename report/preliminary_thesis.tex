...
\item If the proposed location has a lower energy level than the current one, the proposed location is accepted. If it has a higher energy level, it is accepted with a probability antiproportional to the energy increase, that is, the higher the energy increase, the lower the chance of accepting the proposed position. 
\end{enumerate}
...
\cite{hoffman2014no}
\paragraph{NUTS}
a self-tuning variant of Hamiltonian Monte Carlo \cite{Salvatier2016}.Uses gradient information about log-posterior density.
