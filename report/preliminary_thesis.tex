...
In Lumen, several methods have to be specified for a model class to work. One of them is the method that fits the model to the data. In Bayesian statistics, fitting means finding the joint posterior distribution.  
\\
...
\\
conditioning: posterior distribution given the values for the variables in remove
