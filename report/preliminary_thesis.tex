...
\end{figure}
Finally, the joint posterior distribution is visualized, as shown in \ref{fig:ground_truth_joint_posterior_1}.
\begin{figure}
	\includegraphics[width=\textwidth]{images/ground_truth_joint_posterior_1.png}
	\label{fig:ground_truth_joint_posterior_1}
	\caption[Joint probability density of the example model]{Joint probability density of the example model}
\end{figure}
